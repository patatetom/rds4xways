...
> `wc` results can be formated with this `bash` function `bignumber(){ printf "%'d - " $( cat ) | sed 's/ - $//'; }` : `unzip -p /media/NSRLFile.txt.zip | pv | wc | bignumber` will produce `192 677 750 - 194 541 093 - 26 804 404 409`
